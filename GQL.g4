...
fragment ESCAPED_UNICODE4_DIGIT_VALUE options { caseInsensitive=false; }:
	REVERSE_SOLIDUS 'u' HEX_DIGIT HEX_DIGIT HEX_DIGIT HEX_DIGIT;
fragment ESCAPED_UNICODE6_DIGIT_VALUE options { caseInsensitive=false; }:
...
UNSIGNED_HEXADECIMAL_INTEGER options { caseInsensitive=false; }
    : '0x' ('_'? HEX_DIGIT)+
    ;

UNSIGNED_OCTAL_INTEGER options { caseInsensitive=false; }
    : '0o' ('_'? OCTAL_DIGIT)+
    ;

UNSIGNED_BINARY_INTEGER options { caseInsensitive=false; }
    : '0b' ('_'? BINARY_DIGIT)+
    ;
